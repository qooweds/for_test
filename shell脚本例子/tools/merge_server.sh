...
for((i=1;i<${#ARR_SERVER_ID[@]};i++))
do
  if [ "$1" == "${ARR_SERVER_ID[i]}" ] || [ "$2" == "${ARR_SERVER_ID[i]}" ] || [ "$3" == "${ARR_SERVER_ID[i]}" ] || [ "$4" == "${ARR_SERVER_ID[i]}" ] || [ "$5" == "${ARR_SERVER_ID[i]}" ] || [ "$6" == "${ARR_SERVER_ID[i]}" ] || [ "$7" == "${ARR_SERVER_ID[i]}" ] || [ "$8" == "${ARR_SERVER_ID[i]}" ];then
...
echo "merge data is OK.Start server and refresh rank list."
